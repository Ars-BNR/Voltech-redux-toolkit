...
const OrderItem = ({ orderInfo, allOrders, setAllOrders, updateOrders }) => {
        ...
        <div className={classes.ordersItem}>
            ...
            <div className={classes.equipmentOrderBlock}>
                <p className={classes.equipmentOrderBlock__count}>
                    {orderInfo.allCount}{" "}
                    {RenderPhrase(orderInfo.allCount)}
                </p>
                <div className={classes.equipmentsList}>
                    {orderInfo.info &&
                        orderInfo.info.map((item) => (
                            <div key={item.id_equipment} className={classes.equipmentsList__item}>
            ...
            <div className={classes.statusOrderBlock}>
                ...
                <div
                    className={`${classes.statusOrderBlockStatus}  ${classes["statusOrderBlockStatus_process" + handleClass()]
                        }`}
                >
                    <div
                        className={`${classes.statusOrderBlockStatusHeader}  ${classes["statusOrderBlockStatusHeader" + handleClass()]
                            }`}
                            ...
                            <g clipPath="url(#clip51_274)">
                                ...
                                <g clipPath="url(#clip51_277)">
                                    <path
                                        ...
                                        fillRule="nonzero"
                                        className={`${classes.statusOrderBlockStatus__arrow}  ${classes["statusOrderBlockStatus__arrow" + handleClass()]
                                            }`}
                                    />
                                </g>
                            </g>
                    ...
                    <div
                        className={`${classes.statusOrderBlockStatusBody}  ${classes["statusOrderBlockStatusBody" + handleClass()]
                            }`}
                        style={
                            isActive
            ...
            <div className={classes.resultOrderBlock}>
                ...
                <p className={classes.resultOrderBlock__price}>
                    {orderInfo.price.toLocaleString('ru-RU')} <span className="rub">₽</span>
                </p>
                <button className={classes.resultOrderBlock__btn}
